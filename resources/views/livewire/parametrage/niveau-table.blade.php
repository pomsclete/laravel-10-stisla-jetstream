            ...
            <div class="row">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped text-sm text-gray-600">
                        ...
                        <tr>
                            <th><a class="font-bold" wire:click.prevent="sortBy('level')" role="button" href="#">
                                    Libellé du niveau
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row align-items-center">
                        <label for="level" class="form-control-label col-sm-12 col-md-12 text-md-left">{{ __('Libellé du niveau') }}</label>
                        <div class="col-sm-12 col-md-12">
                            <input type="text" wire:model="level" class="form-control" id="level" autocomplete="off">
                            @error('level')
