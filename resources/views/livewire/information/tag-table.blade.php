        ...
        <div class="p-8 pt-4 mt-2 bg-white" x-data="window.__controller.dataTableMainController()" x-init="setCallback();">
            <div class="flex pb-4 -ml-3">
                <button data-toggle="modal" data-target="#createModal"  class="-ml- btn btn-primary shadow">
                    <span class="fas fa-plus"></span> Ajouter un tag
                </button>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row align-items-center">
                        <label for="libelle_francais" class="form-control-label col-sm-12 col-md-12 text-md-left">{{ __('Libellé en francais') }}</label>
                        <div class="col-sm-12 col-md-12">
                            <input type="text" wire:model="libelle_francais" class="form-control" id="libelle_francais">
                    ...
                    <div class="form-group row align-items-center">
                        <label for="libelle_anglais" class="form-control-label col-sm-12 col-md-12 text-md-left">{{ __('Libellé en anglais') }}</label>
                        <div class="col-sm-12 col-md-12">
                            <input type="text" wire:model="libelle_anglais" class="form-control" id="libelle_anglais">
