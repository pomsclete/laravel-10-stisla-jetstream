<div x-data="{ open: false }">
    <div class="section-body">
        <h2 class="section-title">{{ __('Modifier une journée') }}</h2>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route("rencontre.journe") }}"  class="ml-2- btn btn-warning shadow">
                            <span class="fas fa-list"></span> Liste des journée portes ouvertes
                        </a>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-4">
                            <div class="control-label text-md-right col-12 col-md-3 col-lg-3">Possibilité de s'inscrire</div>
                        ...
                        <div class="form-group row mb-4" style="display:{{ ($etat == 1) ? '' : 'none' }}">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Lien</label>
                            <div class="col-sm-12 col-md-7">
                                <input type="text" wire:model="lien" placeholder="Mettre le lien si y'en a sinon laisser vide" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-lg-2 col-md-2">
                                 <div class="col-sm-12 col-lg-2 col-md-2">
                                        ...
                                        @else
                                            <img src="{{ asset('storage/journee/'.$image_first) }}" width="100">
                                        @endif
                                    </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <button id="submit" wire:click.prevent="edit()" class="btn btn-primary">Mettre à jour</button>
                            </div>
                        </div>
                    </div>
                </div>
